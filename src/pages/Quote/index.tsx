...
class Quote extends React.Component {
  ...
  renderQuote (quote: Q, index: number) {
    return (
      <div key={index} className="Quote-content-quote">
        <div className="Quote-content-quote-date">
          {quote.date}
        </div>
        <div className="Quote-content-quote-q">
          {quote.quote}&nbsp;<span className="Quote-content-quote-author">- {quote.author}</span>
        </div>
      </div>
    )
  }
